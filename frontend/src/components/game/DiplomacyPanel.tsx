  ...
  return (
    <div className="bg-gray-800 rounded-lg p-4">
            ...
            <div key={empire.id} className="bg-gray-700 rounded p-3">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center">
                  ...
                  />
                  <span className="text-white font-medium">{empire.name}</span>
                </div>

                <div
                  className={`flex items-center px-2 py-1 rounded-full text-xs ${getRelationColor(relation)}`}
                >
              ...
              <div className="text-xs text-gray-400 mb-2">{getPersonalityDescription(empire)}</div>
      ...
      {otherEmpires.length === 0 && (
        <div className="text-gray-400 text-center py-4">You are alone in the galaxy...</div>
      )}
    </div>
  );
};
